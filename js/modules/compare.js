...
var compare = (function($) {
    ...
    function _onClickAddToCompare(e) {
        ...
        if (comparedCategoryId && categoryId !== comparedCategoryId) {
            alert('Niedozwolone jest porównywanie produktów z różnych kategorii');
            return false;
        }
        ...
        if (comparedGoodsArr.indexOf(goodId) === -1) {
            ...
            alert('Ten produkt jest już na porównywanej liście.');
        }
    }
    ...
    function _initComparePage() {
        ...
        if (!goods) {
            alert('Nie wybrano produktów do porównania');
            return false;
        }
