...
var order = (function($) {
        ...
        var $item = ui.$delivery.btn.filter(':checked'),
            ...
            alert =
                freeDelivery.enabled
                    ...
                    :
                        'Cena dostawy ' + deliverySumma + ' zl. ' +
                        'Całkowita kwota zamówienia: ' +
                        cartSumma + ' + ' + deliverySumma + ' = ' + fullSumma + ' zl';
    ...
    function _orderComplete() {
        ui.$orderBtn.removeAttr('disabled').text('Wyślij zamówienie');
    }
    ...
    function _onSubmitForm(e) {
        ...
        ui.$orderBtn.attr('disabled', 'disabled').text('Zamówienie jest wysyłane...');
        $.ajax({
